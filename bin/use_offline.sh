...
# 替换 src/index.html
sed -i.bak 's|<script src="https://cdn.tailwindcss.com"></script>|<link rel="stylesheet" href="static/css/offline.css">|' src/index.html
...
# 替换 src/viewer.html
sed -i.bak 's|<script src="https://cdn.tailwindcss.com"></script>|<link rel="stylesheet" href="static/css/offline.css">|' src/viewer.html
...
sed -i.bak 's|<script src="https://cdn.tailwindcss.com"></script>|<link rel="stylesheet" href="../static/css/offline.css">|' src/viewer_standalone.html
